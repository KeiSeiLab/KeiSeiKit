...
> RULE 0.5 plan-mode artefact, RULE 0.12 ledger anchor, RULE 0.13 orchestrator-owned branch.
...
5. Final remote check: assert URL matches `127.0.0.1:3001` allowlist; reject `github.com` per RULE 0.1.
...
## Wave 3 implementation (4 streams parallel, RULE 0.13)
...
Per RULE 0.12: AskUserQuestion per branch [merge --no-ff / squash / reject / defer]. Orchestrator commits with `feat(wave46):` prefix.
