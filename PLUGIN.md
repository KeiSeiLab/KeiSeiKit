...
- Network access to `github.com/KeiSeiLab/KeiSeiKit` on `/plugin marketplace add`
...
Open an issue at [github.com/KeiSeiLab/KeiSeiKit/issues](https://github.com/KeiSeiLab/KeiSeiKit/issues). A well-formed problem description is already half the solution.
